...
`;
    ...
    private async collectEnvironmentInfo(): Promise<EnvironmentInfo> {
        ...
        return {
            ...
            'App Package': (ConfigReader.getProperty('android.app.package', 'org.wikipedia.alpha') || 'org.wikipedia.alpha'),
            'App Activity': (ConfigReader.getProperty('android.app.activity', '.main.MainActivity') || '.main.MainActivity'),
            'Automation Name': (ConfigReader.getProperty('automationName', 'UiAutomator2') || 'UiAutomator2'),
